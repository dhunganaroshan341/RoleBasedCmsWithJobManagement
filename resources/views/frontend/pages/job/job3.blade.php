    ...
    <div class="auto-container">
        ...
        <div class="text-center mb-4 d-flex justify-content-center gap-2 flex-wrap">
            <form action="{{ route('jobs') }}" method="GET">
                ...
                <button type="submit" class="btn btn-link p-2 text-dark">
                    <i class="fas fa-search fa-lg"></i>
                </button>

                <a href="{{ route('jobs') }}" class="btn btn-link p-2 text-dark">
                    ...
                    <div class="job-block-one h-100">
                        ...
                        <div class="upper-box">
                            <ul class="job-info">
                                <li>
                                    <i class="icon-43"></i>
                                    Posted <span>{{ $job->created_at->diffInDays(now()) }} days ago</span>
                                </li>
                                <li>
                                    Vacancy Code:
                                    <span>{{ $job->job_code ?? 'VC'.$job->id }}</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="jobs-list-box">
                                <ul>
                                    <li><strong>Openings:</strong>
                                        {{ $job->total_openings ?? (($job->male_opening ?? 0) + ($job->female_opening ??
                                        0)) }}
                                    </li>

                                    @if ($job->vacancy && $job->vacancy->categories->isNotEmpty())
                                    <li><strong>Category:</strong>
                                        {{ $job->vacancy->categories->pluck('name')->join(', ') }}
                                    </li>
                                    @endif
                            ...
                            <div class="btn-box mt-3">
                                <a href="{{ route('jobById', $job->id) }}" class="theme-btn btn-one">
                                    View Details
                                </a>
                            </div>
                        </div>
        ...
        <div id="topCategoriesView" class="inner-container d-none">
            ...
            <h4 class="mb-3 mt-4">
                {{ $cat['category_name'] }} ({{ count($cat['jobs']) }} jobs)
            </h4>
