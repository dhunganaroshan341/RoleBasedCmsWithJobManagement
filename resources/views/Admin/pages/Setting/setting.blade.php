            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="title" id="" class="form-control @error('title') is-invalid @enderror"
                        placeholder="" value="{{ $setting->title ?? '' }}" aria-describedby="helpId" />
                    @error('title')
                ...
                <div class="col-md-6">
                    ...
                    <div>
                        <img src="{{ $setting->logo }}" alt="" srcset="" width="100" height="100">
                    </div>
                    @endif
                </div>
                ...
                <div class="col-md-4 mt-3 mb-3">
                    ...
                    <input type="email" name="email" id="" class="form-control @error('email') is-invalid @enderror"
                        placeholder="" value="{{ $setting->email ?? '' }}" aria-describedby="helpId" />
                    @error('email')
                    <small id="helpId" class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-md-4 mt-3 mb-3">
                    ...
                    <input type="text" name="address" id="" class="form-control @error('address') is-invalid @enderror"
                        placeholder="" value="{{ $setting->address ?? '' }}" aria-describedby="helpId" />
                    @error('address')
                    <small id="helpId" class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <textarea class="form-control description" name="description" id=""
                ...
                <div class="col-md-6">
                    ...
                    <div>
                        <img src="/storage/{{ $setting->welcome_image }}" alt="" srcset="" width="100" height="100">
                    </div>
                    @endif
                </div>
                <div class="col-md-6">
                    ...
                    <div>
                        <img src="/storage/{{ $setting->about_image }}" alt="" srcset="" width="100" height="100">
                    </div>
                    @endif
                </div>
                ...
                <div class="mb-3 mt-2">
                    ...
                    <textarea class="form-control description" name="work_description" id=""
                        rows="3">{!! $setting->work_description ?? '' !!}</textarea>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="url" name="instagram_url" id="" value="{{ $setting->instagram_url ?? '' }}"
