    ...
    <form id="updateSiteData" method="POST" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="site_title" id="" class="form-control @error('site_title')is-invalid @enderror"
                    placeholder="" value="{{ $siteData->site_name ?? '' }}" />
                @error('site_title')
            ...
            <div class="col-md-6">
                ...
                <input type="file" name="site_logo" id="" class="form-control @error('site_logo')is-invalid @enderror"
                    placeholder="" />
                <div>
            ...
            <div class="row mt-3 mb-3">
                ...
                <div class="row mt-2 mb-2">
                    ...
                    <div class="col-md-2 mt-4">
                        <button type="button" class="btn btn-dark mt-1 addMoreBtn">Add More</button>
