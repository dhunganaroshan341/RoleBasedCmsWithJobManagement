                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="vacancy_id" id="vacancy_id" class="form-select rounded-3 shadow-sm" required>
                                <option value="">-- Select Vacancy --</option>

                                @foreach (\App\Models\Vacancy::latest()->get() as $vacancy)
                                <option value="{{ $vacancy->id }}">
                                    {{ $vacancy->title }} - {{ $vacancy->custom_company_name ?? $vacancy->company->name
                                    ?? '' }}
                                </option>
                                @endforeach
                        ...
                        {{-- Interview Date --}}
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Interview Date(optional)</label>
